...
public class RecipeMain{
    ...
    public static void main(String[] args) {
        try {
            ...
            while (true) {
                ...
                System.out.println("|     3. Search Recipes by Ingredient   |");
                System.out.println("|     4. Search Recipes by Name         |");
                System.out.println("|     5. update Recipes by Name         |");
                System.out.println("|     6. delete Recipes by Name         |");
    ...
    private static void createInstructionTableIfNotExists() throws SQLException {
        try (Connection connection = DriverManager.getConnection(DB_URL  , "root" , "shankar@3002");
